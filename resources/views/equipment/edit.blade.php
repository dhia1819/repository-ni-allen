...
<div class="row mt-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Update Equipment </h5>
        <br>
        <form method="POST" action="{{ route('equipment.update', ['id' => $equipment->id]) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
    ...
    <div class="col-md-6">
        ...
        <div class="image-preview-container text-center mt-2">
            <img id="image-preview" src="{{ $equipment->image ? asset('uploads/' . $equipment->image) : 'https://via.placeholder.com/100x100' }}" alt="Image Preview" class="img-fluid" style="width: 100px; height: 100px;">
        </div>
    </div>
