$(document).ready(function() {
    ...
    // Initialize DataTable on #tbl-late table after processing borrowedData
    $('#tbl-late').DataTable({
        paging: true,
        language: {
            paginate: {
    ...
    function applyFilters() {
        ...
        if (allFiltersCleared) {
            $('#tbl-late_info').text('Showing ' + (info.start + 1) + ' to ' + info.end + ' of ' + info.recordsTotal + ' entries');
        } else {
            $('#tbl-late_info').text('Showing ' + (info.start + 1) + ' to ' + info.end + ' of ' + info.end + ' entries (filtered from ' + info.recordsTotal + ' total entries)');
        }
